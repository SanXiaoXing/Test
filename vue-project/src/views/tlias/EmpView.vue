<template>
    <div>
        <el-container style="height: 700px; border: 1px solid #eee">
            ...
            <el-container>
                <el-aside width="240px" style=" 700px; border: 1px solid #eee">
                    <el-menu :default-openeds="['1', '3']">
                        <el-submenu index="1">
                            <template slot="title"><i class="el-icon-message"></i>系统信息管理</template>
                            <el-menu-item index="1-1">
                                <router-link to="/emp">部门管理</router-link>
                            </el-menu-item>

                            <el-menu-item index="1-2">
                                <router-link to="/element">学员管理</router-link>
                            </el-menu-item>
                        </el-submenu>
                        <el-submenu index="2">
                ...
                <el-main>
                    ...
                    <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange"
                        layout="sizes, prev, pager, next, jumper " :total="100">
                    </el-pagination>
                </el-main>
...
export default {
    ...
    mounted(){
        //发送异步请求，获取数据
        axios.get("https://raw.githubusercontent.com/SanXiaoXing/Test/yx/tool/test.json").then((result) => {
